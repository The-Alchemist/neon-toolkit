 ...
 */
public class OWLXMLOntologyFileFilter extends AbstractOWLFileFilter {
    
    private static final String WILDCARD_EXTENSIONS = "*"+OWLConstants.OWLXML_EXTENSION; //$NON-NLS-1$ 
    ...
    public String getDefaultExtension() {
        return OWLConstants.OWLXML_EXTENSION;
    }
    ...
    public String getDescription() {
        return "OWL/XML Syntax (" + WILDCARD_EXTENSIONS + ")"; //$NON-NLS-1$ //$NON-NLS-2$
    }
}
