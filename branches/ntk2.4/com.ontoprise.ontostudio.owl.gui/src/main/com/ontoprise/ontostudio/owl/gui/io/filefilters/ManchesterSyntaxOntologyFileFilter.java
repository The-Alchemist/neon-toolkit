 ...
 */
public class ManchesterSyntaxOntologyFileFilter extends AbstractOWLFileFilter {
    
    private static final String WILDCARD_EXTENSIONS = "*"+OWLConstants.MANCHESTER_SYNTAX_EXTENSION; //$NON-NLS-1$ 
    ...
    public String getDefaultExtension() {
        return OWLConstants.MANCHESTER_SYNTAX_EXTENSION;
    }
    ...
    public String getDescription() {
        return "OWL Manchester Syntax (" + WILDCARD_EXTENSIONS + ")"; //$NON-NLS-1$ //$NON-NLS-2$
    }
