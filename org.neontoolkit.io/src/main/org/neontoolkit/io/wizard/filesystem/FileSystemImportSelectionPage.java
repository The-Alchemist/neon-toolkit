...
package org.neontoolkit.io.wizard.filesystem;
...
public class FileSystemImportSelectionPage extends AbstractImportSelectionPage {
    ...
    public FileSystemImportSelectionPage(FileFilter filter) {
        super(filter);
        setTitle(Messages.getString("FileSystemImportSelectionPage.1")); //$NON-NLS-1$
        setDescription(Messages.getString("FileSystemImportSelectionPage.2")); //$NON-NLS-1$
    }
    ...
    public void createControl(Composite parent) {
        ...
        fileLabel.setText(Messages.getString("FileSystemImportSelectionPage.3")); //$NON-NLS-1$
        ...
        _browseButton.setText(Messages.getString("FileSystemImportSelectionPage.4")); //$NON-NLS-1$
...
//        _importAsRDFButton.setLayoutData(gridData);
    ...
    protected String browse() {
        ...
        if (_fileFilter != null && _fileFilter.getExtension().length() > 0) {
            ...
            dirDialog.setText(Messages.getString("FileSystemImportSelectionPage.12")); //$NON-NLS-1$
            dirDialog.setMessage(Messages.getString("FileSystemImportSelectionPage.13")); //$NON-NLS-1$
            if (_fileInput.getText().length() > 0) {
        ...
        if(pageComplete) {
            try {                
            	...
            	if(filesNotSupported.size() > 0) {        		
            		...
            		messages += Messages.getString("AbstractImportSelectionPage.9") + " " + ontologyProjectLanguage + " " + Messages.getString("AbstractImportSelectionPage.10");  //$NON-NLS-1$ //$NON-NLS-2$//$NON-NLS-3$ //$NON-NLS-4$
