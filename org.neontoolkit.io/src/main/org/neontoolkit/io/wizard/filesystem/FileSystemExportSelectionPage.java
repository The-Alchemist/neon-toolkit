...
public class FileSystemExportSelectionPage extends AbstractExportSelectionPage {
        ...
        public void widgetSelected(SelectionEvent se) {
            if (se.getSource().equals(_browseButton)) {
                ...
                if (_fileFilters != null) {
                    ...
                    dirDialog.setText(Messages.getString("FileSystemExportSelectionPage.3")); //$NON-NLS-1$
                    dirDialog.setMessage(Messages.getString("FileSystemExportSelectionPage.4")); //$NON-NLS-1$
                    if (_fileInput.getText().length() > 0) {
    ...
    public FileSystemExportSelectionPage(FileFilter[] filters) {
        super(filters); 
        setTitle(Messages.getString("FileSystemExportSelectionPage.7")); //$NON-NLS-1$
        setDescription(Messages.getString("FileSystemExportSelectionPage.8")); //$NON-NLS-1$
    }
    ...
    public void createControl(Composite parent) {
        ...
        projectLabel.setText(Messages.getString("FileSystemExportSelectionPage.9")); //$NON-NLS-1$
        ...
        ontoLabel.setText(Messages.getString("FileSystemExportSelectionPage.10")); //$NON-NLS-1$
        gridData = new GridData(GridData.HORIZONTAL_ALIGN_BEGINNING);
        ...
        fileLabel.setText(Messages.getString("FileSystemExportSelectionPage.11")); //$NON-NLS-1$
        gridData = new GridData(GridData.HORIZONTAL_ALIGN_BEGINNING);
        ...
        _browseButton.setText(Messages.getString("FileSystemExportSelectionPage.12")); //$NON-NLS-1$
