...
public class Messages extends NLS {
    ...
    public static String LegendControlPanel_0short;
    ...
    public static String NavigationHistoryControlPanel_4short;
    ...
    public static String TooltipControlPanel_0short;
