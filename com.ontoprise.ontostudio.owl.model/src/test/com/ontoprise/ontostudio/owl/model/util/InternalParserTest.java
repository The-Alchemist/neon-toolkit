...
public class InternalParserTest {
    ...
    @DataPoint public static final SWRLVariable atomDVariable0 = _f.getSWRLVariable(iri("atomDVariable0"));
    ...
    @DataPoint public static final SWRLVariable atomIVariable0 = _f.getSWRLVariable(iri("atomIVariable0"));
    ...
    @DataPoint public static final SWRLDifferentIndividualsAtom differentFromAtom0 = _f.getSWRLDifferentIndividualsAtom(atomIndividualObject0, atomIndividualObject1);
    @DataPoint public static final SWRLDifferentIndividualsAtom differentFromAtom1 = _f.getSWRLDifferentIndividualsAtom(atomIVariable0, atomIndividualObject1);
    @DataPoint public static final SWRLDifferentIndividualsAtom differentFromAtom2 = _f.getSWRLDifferentIndividualsAtom(atomIndividualObject0, atomIVariable0);
    ...
    @DataPoint public static final SWRLSameIndividualAtom sameAsAtom0 = _f.getSWRLSameIndividualAtom(atomIndividualObject0, atomIndividualObject1);
    @DataPoint public static final SWRLSameIndividualAtom sameAsAtom1 = _f.getSWRLSameIndividualAtom(atomIVariable0, atomIndividualObject1);
    @DataPoint public static final SWRLSameIndividualAtom sameAsAtom2 = _f.getSWRLSameIndividualAtom(atomIndividualObject0, atomIVariable0);
