 ...
 * 
 */
public class GetSubAnnotationPropertyHits extends OWLOntologyRequestCommand {
     ...
     * @param arguments
     */
    public GetSubAnnotationPropertyHits(String project, String module, String propertyUri) {
    ...
    protected void perform() throws CommandException {
        ...
        try {
            results = getOwlModel().getSubAnnotationPropertyHits(propertyUri);
