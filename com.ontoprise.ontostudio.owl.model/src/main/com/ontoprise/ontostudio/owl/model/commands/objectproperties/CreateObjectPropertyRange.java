...
public class CreateObjectPropertyRange extends OWLModuleChangeCommand {
    ...
    protected void doPerform() throws CommandException {
        try {
            ...
            OWLClassExpression range = OWLUtilities.description((String) getArgument(3), ns, factory);
            new ApplyChanges(getProjectName(), getOntology(), new OWLAxiom[]{factory.getOWLObjectPropertyRangeAxiom(propertyUri, range)}, new OWLAxiom[0]).perform();
