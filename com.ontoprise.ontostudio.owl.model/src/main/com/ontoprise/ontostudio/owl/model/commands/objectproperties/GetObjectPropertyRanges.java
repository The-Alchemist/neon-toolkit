 ...
 *
 */
public class GetObjectPropertyRanges extends OWLOntologyRequestCommand {
     ...
     * @param arguments
     */
    public GetObjectPropertyRanges(String project, String module, String propertyUri) {
    ...
    protected void perform() throws CommandException {
        ...
        try {
            Set<ItemHits<OWLClassExpression,OWLObjectPropertyRangeAxiom>> results = getOwlModel().getObjectPropertyRangeDescriptionHits(propertyUri);
            for (ItemHits<OWLClassExpression,OWLObjectPropertyRangeAxiom> hit: results) {
                Set<LocatedItem<OWLObjectPropertyRangeAxiom>> axioms = hit.getAxioms();
                for (LocatedItem<OWLObjectPropertyRangeAxiom> item: axioms) {
