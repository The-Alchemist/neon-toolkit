...
public class GetSuperObjectPropertyHits extends OWLOntologyRequestCommand {
    ...
    protected void perform() throws CommandException {
        ...
        Set<ItemHits<OWLClassExpression,OWLSubObjectPropertyOfAxiom>> results = new HashSet<ItemHits<OWLClassExpression,OWLSubObjectPropertyOfAxiom>>();
        try {
            results = getOwlModel().getSuperObjectPropertyHits(propertyUri);
            for (ItemHits<OWLClassExpression,OWLSubObjectPropertyOfAxiom> hit: results) {
