 ...
 */
public class ShowPropertiesOfAllSuperclassesInTheDomainView extends AbstractHandler {

    @Override
    public Object execute(ExecutionEvent arg0) throws ExecutionException {
        IPreferenceStore store = NeOnUIPlugin.getDefault().getPreferenceStore();
        Boolean oldValue = store.getBoolean(OWLPlugin.SHOW_PROPERTIES_OF_ALL_SUPERCLASSES_IN_DOMAIN_VIEW_PREFERENCE);
        Boolean newValue = !oldValue;
        store.setValue(OWLPlugin.SHOW_PROPERTIES_OF_ALL_SUPERCLASSES_IN_DOMAIN_VIEW_PREFERENCE, newValue);
