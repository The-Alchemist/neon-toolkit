...
public class MoveAnnotationPropertyProcessor extends MoveProcessor {
    public static final String IDENTIFIER = "com.ontoprise.ontostudio.owl.gui.refactor.move.MovePropertyProcessor"; //$NON-NLS-1$
    public static final PropertyTreeElement ROOT = new AnnotationPropertyTreeElement("root", "root", "root", null); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	 ...
	 * 
	 */
    public MoveAnnotationPropertyProcessor(PropertyTreeElement[] elements, PropertyTreeElement[] parents) {
        _elements = elements;
        _parents = parents;
    }
    ...
    public String getProcessorName() {
        return "com.ontoprise.ontostudio.owl.gui.refactor.moveAnnotationProperty";  //$NON-NLS-1$
    }
