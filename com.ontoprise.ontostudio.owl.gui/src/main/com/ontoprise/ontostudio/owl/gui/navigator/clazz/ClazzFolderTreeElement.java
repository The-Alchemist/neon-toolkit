...
public class ClazzFolderTreeElement extends AbstractOwlFolderTreeElement {

    private static final String FOLDER_NAME = Messages.ClazzFolderTreeElement_0; 

    public ClazzFolderTreeElement(String projectName, String ontologyId, ITreeDataProvider provider) {
