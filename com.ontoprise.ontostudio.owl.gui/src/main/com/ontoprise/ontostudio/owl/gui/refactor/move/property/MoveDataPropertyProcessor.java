...
public class MoveDataPropertyProcessor extends MoveProcessor {
	 ...
	 * 
	 */
    public MoveDataPropertyProcessor(PropertyTreeElement[] elements, PropertyTreeElement[] parents) {
        _elements = elements;
        _parents = parents;
    }
    ...
    public String getProcessorName() {
        return "com.ontoprise.ontostudio.owl.gui.refactor.moveDataProperty";  //$NON-NLS-1$
    }
