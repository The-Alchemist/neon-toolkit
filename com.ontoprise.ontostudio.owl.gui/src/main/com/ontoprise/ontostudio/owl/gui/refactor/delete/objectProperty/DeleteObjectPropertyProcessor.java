...
public class DeleteObjectPropertyProcessor extends DeleteProcessor {
    public static final String IDENTIFIER = "com.ontoprise.ontostudio.owl.gui.refactor.delete.objectProperty.DeleteObjectPropertyProcessor"; //$NON-NLS-1$

    private ObjectPropertyTreeElement[] _elements;
    private ObjectPropertyTreeElement[] _parents;

    public DeleteObjectPropertyProcessor(ObjectPropertyTreeElement[] elements, ObjectPropertyTreeElement[] parents) {
        _elements = elements;
        _parents = parents;
    }
    ...
    public String getProcessorName() {
        return Messages.DeleteObjectPropertyProcessor_5; 
    }
    ...
    public Change createChange(IProgressMonitor pm) throws CoreException,OperationCanceledException {
        return new ObjectPropertyDeleteChange(_elements, _parents);
    }
