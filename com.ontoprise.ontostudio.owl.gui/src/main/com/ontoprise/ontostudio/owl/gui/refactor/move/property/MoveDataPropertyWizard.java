...
public class MoveDataPropertyWizard extends RefactoringWizard {

    public MoveDataPropertyWizard(Refactoring ref) {
    ...
    protected void addUserInputPages() {
         addPage(new MoveDataPropertyPage((MoveDataPropertyProcessor)getRefactoring().getAdapter(MoveDataPropertyProcessor.class)));
    }
}
