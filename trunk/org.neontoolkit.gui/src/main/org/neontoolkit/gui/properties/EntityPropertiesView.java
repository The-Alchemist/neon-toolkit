...
public class EntityPropertiesView extends ViewPart implements ISelectionListener {
    ...
    public void createPartControl(Composite parent) {
        ...
        for (int i = 0; i < _propertyActivators.length; i++) {
            ...
            try {
                ...
                new NeonToolkitExceptionHandler().handleException(Messages.EntityPropertiesView_1 + currentActivator.getId(), e, composite.getShell());
            }
        }
    ...
    /**
     * Adds a selectionlistener to the entity properties view. Listeners get notified, if the selected page changes.
     * 
     * @param listener
     */
