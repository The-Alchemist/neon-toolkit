 ...
 * 
 */
public class GetSubDescriptionHits extends OWLOntologyRequestCommand {
     ...
     * @param arguments
     */
    public GetSubDescriptionHits(String project, String module, String superClazzUri) {
    ...
    public void perform() throws CommandException {
        ...
        try {
            ...
            Set<ItemHits<OWLClassExpression,OWLSubClassOfAxiom>> subDescriptionHits = getOwlModel().getSubDescriptionHits(superClazzUri);
            for (ItemHits<OWLClassExpression,OWLSubClassOfAxiom> hit: subDescriptionHits) {
