 ...
 * @author Nico Stieler
 */
public class SaveAllOntologiesRunnableWithProgress implements IRunnableWithProgress {
	private String _ontologyUri;
	private String _project;
	
	public SaveAllOntologiesRunnableWithProgress(String project, String ontologyUri) {
